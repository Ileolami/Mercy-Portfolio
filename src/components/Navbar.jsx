  ...
  return (
    <nav className="p-6 relative">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        <h1 className="text-2xl font-bold text-444554">Makinde Mercy Miracle</h1>
        ...
        {isOpen && (
          <div className="absolute top-full left-0 w-full bg-eerieBlack text-paleDogwood shadow-lg md:hidden p-4 z-50">
            <div className="flex flex-col items-center space-y-6">
              <a href="https://github.com/ileolami" className="hover:text-blue-400 flex items-center space-x-3 text-white w-full justify-center py-3 border border-gray-700 rounded-lg">
                <Github /> <span>GitHub</span>
              </a>
              <a href="https://www.linkedin.com/in/makindemercymiracle" className="hover:text-blue-400 flex items-center space-x-3 text-white w-full justify-center py-3 border border-gray-700 rounded-lg">
